...
def extract_text(image) -> str:
    ...
    config = "--psm 6 -c tessedit_char_whitelist=0123456789/" #single word 8, 7 for single line
...
# predetermined_region = SearchPattern.ITEM.value
# predetermined_region = SearchPattern.EQUIPMENT_OWNED.value
# predetermined_region = SearchPattern.AP.value
predetermined_region = SearchPattern.PYROXENE.value
...
print(f"Image: {screenshot_path} How Many: {text}")
